  ...
  return (
    <div className="min-h-screen bg-gray-900 overflow-hidden">
      <div className="flex flex-col md:flex-row">
        ...
        {/* Right: Playlist Carousel */}
        <div className="w-full md:w-1/3 p-4 border-t md:border-t-0 md:border-l border-gray-700 flex flex-col space-y-4">
          ...
          {loading ? (
            ...
            <div className="flex flex-col space-y-4 max-h-[75vh] overflow-y-auto flex-grow">
              {playlist.items.map((item) => (
                <div
                  key={item.id}
                  onClick={() => setSelectedVideo(item)}
                  className={`cursor-pointer rounded-lg border p-2 hover:shadow-md transition-shadow duration-200 ${
